...
public class EventRecyclerAdapter extends RecyclerView.Adapter<EventRecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        timecalender.setTime(ConvertStringToDate(events.getDATE()));
        final int alarmHour = timecalender.get(Calendar.HOUR_OF_DAY);
        final int alarmMinut = timecalender.get(Calendar.MINUTE);
        ...
        holder.setAlarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isAarmed(events.getDATE(),events.getEVENT(),events.getTIME())){
                    ...
                    alarmCalender.set(alarmYear,alarmMonth,alarmDay,alarmHour,alarmMinut);
